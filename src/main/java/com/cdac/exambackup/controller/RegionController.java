...
public class RegionController extends AbstractBaseController<Region, Long> {
    ...
    public ResponseDto<?> get(@PathVariable("id") @Valid Long id) {
        ...
        return new ResponseDto<>(FETCH_SUCCESS_MSG, JsonNodeUtil.getJsonNode(commonPropertyFilter, this.regionService.getById(id)));
    }
    ...
    public ResponseDto<?> getAll() {
        ...
        return new ResponseDto<>(FETCH_SUCCESS_MSG, JsonNodeUtil.getJsonNode(commonPropertyFilter, this.regionService.getAll()));
    }
    ...
    public ResponseDto<?> getAllByPage(@PageableDefault Pageable pageable) {
        log.info("getAllByPage Request for the Region entity in the controller for code, name");
        SimpleBeanPropertyFilter simpleBeanPropertyFilter = SimpleBeanPropertyFilter.serializeAll();
        return new ResponseDto<>(FETCH_SUCCESS_MSG, JsonNodeUtil.getJsonNode(simpleBeanPropertyFilter, this.regionService.getAllByPage(pageable)));
    }
}
